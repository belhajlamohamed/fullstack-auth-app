...
# Initialisation du client (Assurez-vous d'utiliser la version stable)
    ...
    try:
        response = client.models.generate_content(
            ...
            config=types.GenerateContentConfig(
                system_instruction=(
                    "Tu es un expert en pédagogie et en sciences. Génère 10 questions précises. "
                    "Chaque question doit avoir exactement 4 options dont une seule est correcte. "
                    "IMPORTANT : Pour TOUTES les formules mathématiques, utilise le format LaTeX entouré de $, "
                    "par exemple : $E=mc^2$. Utilise des doubles antislashs pour les commandes (ex: $\\frac{a}{b}$)."
                ),
        ...
        # Si l'erreur persiste, cela peut être dû à la région ou à la version du SDK
